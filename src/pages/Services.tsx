...
const IMAGES = {
  ...
  tracks: [
    'https://images.unsplash.com/photo-1552664730-d307ca884978?w=1000&q=85',
    'https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=1000&q=85',
    'https://images.unsplash.com/photo-1611632622046-7e7b7e675a0a?w=1000&q=85'
  ]
}
      ...
      <div className="max-w-[1800px] mx-auto px-6 md:px-12 lg:px-20 relative z-10">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-end gap-16 mb-24">
            <div className="max-w-5xl">
              ...
              <h1 className="font-display text-[clamp(3.5rem,9vw,9rem)] leading-[0.85] font-light tracking-tighter uppercase">
                <SplitText text={copy.services.overview.heroTitleLine1} type="words" />
                <div className="overflow-hidden">
                  <span className="block italic opacity-40 translate-y-2">
                    <SplitText text={copy.services.overview.heroTitleLine2} type="words" />
                  </span>
                </div>
              </h1>
            </div>
        ...
        <section className="py-40 flex flex-col gap-24">
          {copy.services.overview.tracks.map((track, index) => (
            <div key={index} className="group grid grid-cols-12 gap-8 md:gap-16 items-center reveal-services">
              <div className={`col-span-12 lg:col-span-7 h-[500px] md:h-[600px] rounded-2xl overflow-hidden relative shadow-2xl ${index % 2 !== 0 ? 'lg:order-2' : ''}`}>
                <CinematicImage
              ...
              <div className={`col-span-12 lg:col-span-5 space-y-12 ${index % 2 !== 0 ? 'lg:order-1' : ''}`}>
