...
const ar = {
  ...
  about: {
    ...
    title: 'منهج Lightlab',
    subtitle: 'نحن شريك يجمع بين الاستراتيجية والتنفيذ لمساعدة الفرق على التوسع عبر الذكاء الاصطناعي والهندسة والوسائط الأدائية.',
    overview: {
  ...
  contact: {
    ...
    serviceQuestion: '01 — ما الخدمة التي تهمك؟',
    nameLabel: '02 — الاسم',
