  ...
  en: {
    ...
    about: {
      ...
      overview: {
        ...
        heroTitleLine1: 'Visionary Mindset &',
        heroTitleLine2: 'Technical Craft.',
        heroImageAlt: 'About lightlab',
        manifestoLabel: 'Our manifesto',
        manifestoLead: 'We believe technology should multiply human talent, not automate it away.',
        manifestoCopy: 'Lightlab was born to reconcile high-end luxury aesthetics with the raw power of agentic automation. We do not just build tools; we architect compounding assets.',
...
const ar = {
  ...
  home: {
    ...
    ctaCopy: 'شارك أهدافك. سنصمم خطة تنفيذ تغطي الأتمتة والتطوير والنمو المدفوع.',
